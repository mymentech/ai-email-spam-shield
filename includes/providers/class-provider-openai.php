<?php
/**
 * Provider_OpenAI — OpenAI Chat Completions API.
 *
...
class Provider_OpenAI extends Provider_LLM_Base {

    protected function get_endpoint(): string {
        if ( empty( $this->options['openai_key'] ) ) {
            return '';
        }
    ...
    protected function get_headers(): array {
        return [
            ...
            'Authorization' => 'Bearer ' . ( $this->options['openai_key'] ?? '' ),
        ];
    }
